...
struct asend_ops{
    ...
    void (*xemacps_DmaSetupRecvBuffers)(u32 paddr, struct net_device *ndev);
    int (*xemacps_DmaSetupRecvBuffers1)(u32 paddr, u32 size, struct net_device *ndev);
    int (*xemacps_DmaSetupRecvBuffers3)(u32 paddr, int rm_num, struct net_device *ndev);
